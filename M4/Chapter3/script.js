...
const forceInfo = {
  ...
  normal: {
    ...
    formula: "\\[N=mg\\quad\\\\\\] เมื่อวัตถุอยู่บนพื้นราบและไม่มีแรงอื่นในแนวดิ่ง",
  ...
  spring: {
    ...
    formula: "\\[F_s=kx\\]",
    vars: "Fs คือ แรงสปริง, k คือ ค่านิจสปริง, x คือ ระยะยืดหรือหดจากตำแหน่งสมดุล"
  },
  friction: {
    ...
    vars: "fs คือ แรงเสียดทานสถิต, fk คือ แรงเสียดทานจลน์, μ คือ สัมประสิทธิ์ความเสียดทาน"
  }
};
  ...
  slope: {
    ...
    draw: () => `
      <g transform="rotate(-25 260 210)">
        ...
        ${line(110, 235, 206, 235, "#dc2626", 4, "f", 148, 225)}
      </g>
